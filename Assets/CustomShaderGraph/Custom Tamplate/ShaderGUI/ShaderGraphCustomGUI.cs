...
namespace UnityEditor
{
    ...
    class ShaderGraphCustomGUI : BaseShaderGUI
    {
        ...
        public static void UpdateMaterial(Material material, MaterialUpdateType updateType)
        {
            ...
            CustomGUI.SetupSpecularWorkflowKeyword(material, out bool isSpecularWorkflow);
        ...
        public override void DrawSurfaceOptions(Material material)
        {
            ...
            if (workflowMode != null)
                DoPopup(CustomGUI.Styles.workflowModeText, workflowMode, Enum.GetNames(typeof(CustomGUI.WorkflowMode)));
