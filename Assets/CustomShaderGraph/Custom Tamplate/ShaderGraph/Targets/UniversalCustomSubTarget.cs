...
{
    sealed class UniversalCustomSubTarget : UniversalSubTarget, ILegacyTarget
    {
        static readonly GUID kSourceCodeGuid = new GUID("d6c78107b64145745805d963de80cc19"); // UniversalCustomSubTarget.cs
        ...
        static class CustomIncludes
        {
            ...
            public static readonly IncludeCollection Forward = new IncludeCollection
            {
                ...
                //{ kUnlitPass, IncludeLocation.Postgraph },//kForwardPass
                { customUnlitPass, IncludeLocation.Postgraph },//kForwardPass
            };
            ...
            public static readonly IncludeCollection GBuffer = new IncludeCollection
            {
                ...
                //{ kUnlitGBufferPass, IncludeLocation.Postgraph },
                { customUnlitGBufferPass, IncludeLocation.Postgraph },
            };
