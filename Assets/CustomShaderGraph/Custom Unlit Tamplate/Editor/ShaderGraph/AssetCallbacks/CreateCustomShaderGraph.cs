...
{
    static class CreateCustomShaderGraph
    {
        //[GenerateBlocks]
        ...
        [MenuItem("Assets/Create/Shader Graph/URP/Custom Unlit Shader Graph", priority = CoreUtils.Priorities.assetsCreateShaderMenuPriority + 100 + 2)]
        public static void CreateCustomGraph()
        {
            var target = (UniversalTarget)Activator.CreateInstance(typeof(UniversalTarget));
            target.TrySetActiveSubTarget(typeof(UniversalCustomSubTarget));
