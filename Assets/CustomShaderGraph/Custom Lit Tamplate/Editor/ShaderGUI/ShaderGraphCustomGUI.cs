...
{
    // Used for ShaderGraph Custom shaders
    class ShaderGraphCustomLitGUI : BaseShaderGUI
    {
        ...
        public static void UpdateMaterial(Material material, MaterialUpdateType updateType)
        {
            ...
            CustomLitGUI.SetupSpecularWorkflowKeyword(material, out bool isSpecularWorkflow);
        ...
        public override void DrawSurfaceOptions(Material material)
        {
            ...
            if (workflowMode != null)
                DoPopup(CustomLitGUI.Styles.workflowModeText, workflowMode, Enum.GetNames(typeof(CustomLitGUI.WorkflowMode)));
