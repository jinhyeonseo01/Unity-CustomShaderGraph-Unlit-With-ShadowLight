...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    ...
    /// </summary>
    public static class CustomLitGUI
    {
        /// <summary>
        ...
        /// <summary>
        /// Container for the properties used in the <c>CustomGUI</c> editor script.
        /// </summary>
        ...
        public static void Inputs(CustomProperties properties, MaterialEditor materialEditor, Material material)
        {
        ...
        private static void DoHeightmapArea(CustomProperties properties, MaterialEditor materialEditor)
        {
        ...
        /// <param name="materialEditor"></param>
        /// <param name="material"></param>
        public static void DoClearCoat(CustomProperties properties, MaterialEditor materialEditor, Material material)
        {
        ...
        /// <param name="materialEditor"></param>
        /// <param name="material"></param>
        public static void DoMetallicSpecularArea(CustomProperties properties, MaterialEditor materialEditor, Material material)
        {
